# [C/C++ 开源库及示例代码](https://github.com/caojie060/opensource/blob/master/libs/cpp.wiki)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/SQLite) [维基百科](https://zh.wikipedia.org/wiki/SQLite)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/Libxml2)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/OpenCV) [维基百科](https://zh.wikipedia.org/wiki/OpenCV)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/FFmpeg) [维基百科](https://zh.wikipedia.org/wiki/FFmpeg)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/Libav)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/PortAudio)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/OpenAL) [维基百科](https://zh.wikipedia.org/wiki/OpenAL)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/Id_Tech)

这个系列来自于大名鼎鼎的 [id Software 公司](https://en.wikipedia.org/wiki/Id_Software)，由同样大名鼎鼎约翰·卡马克打造。
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/Crystal_Space)
...
它是 [Blender](https://en.wikipedia.org/wiki/Blender_(software)) 的组成部分，以 C++ 编写，使用 Python 脚本扩展。功能包括：3D 渲染、碰撞检测、角色编辑器、音效、网络通讯、AI、...
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/Panda3D)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/OGRE) [维基百科](https://zh.wikipedia.org/wiki/OGRE)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/Mesa_(computer_graphics)) [维基百科](https://zh.wikipedia.org/wiki/Mesa_3D)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/Bullet_(software)) [维基百科](https://zh.wikipedia.org/wiki/Bullet)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/Box2D) [维基百科](https://zh.wikipedia.org/wiki/Box2D)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/Open_Dynamics_Engine) [维基百科](https://zh.wikipedia.org/wiki/Open_Dynamics_Engine)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/Newton_Game_Dynamics)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/GNU_Scientific_Library)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/GNU_Multiple_Precision_Arithmetic_Library) [维基百科](https://zh.wikipedia.org/wiki/GNU多重精度运算库)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/Blitz%2B%2B)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/Armadillo_(C%2B%2B_library))
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/Cython)
...
Links：[Wikipedia](https://en.wikipedia.org/wiki/Chrome_V8)
